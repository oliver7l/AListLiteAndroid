...
public class Constants {
    public static String OPENLIST_VERSION = "4.2.2";
    ...
    public static String ANDROID_SHARED_DATA_KEY_WEBDAV_USERNAME = "webdav_username";
    public static String ANDROID_SHARED_DATA_KEY_WEBDAV_PASSWORD = "webdav_password";
